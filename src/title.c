...
const color_t default_title_background  = GUI_RGB(0x00, 0x00, 0x00); 
const color_t default_title_foreground  = GUI_RGB(0x9e, 0x9e, 0x9e);
const color_t default_button_foreground = GUI_RGB(0x42, 0x42, 0x42);
...
void gui_title_create(window_t *win)
{
    ...
    hide_btn->gc.foreground   = default_button_foreground;
